...
#         widget.bind("<MouseWheel>", lambda e: scroll(-1*(e.delta//120)))
...
#     city_var    = tk.StringVar(value=env_data.get("WEATHER_CITY", "Bengaluru"))
...
#     # Section 6 — About
#     # ═══════════════════════════════════════════════════════════════════════
#     s6 = _section(content, "ℹ  About")
#     about_row = tk.Frame(s6, bg=_c("CARD"))
#     about_row.pack(fill="x", padx=14, pady=10)
#     tk.Label(about_row,
#              text="Desktop Cat Companion\nBuilt with Python + tkinter\nPhase 9 of 11",
